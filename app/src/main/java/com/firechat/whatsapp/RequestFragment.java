                                    ...
                                    if (type.equals("received")) {
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                holder.userStatus.setText("vuole chattare con te.");
                                                                                                            ...
                                                                                                            if (task.isSuccessful()) {
                                                                                                                ChatReferenceRef.child(list_user_id).child(currentUserID)
                                                                                                                        ...
                                                                                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                            ...
                                                                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                                                                if (task.isSuccessful()) {
                                                                                                                                    Toast.makeText(getContext(), "Nuovo contatto salvato", Toast.LENGTH_SHORT).show();
                                                                                                                                }
                                                                                                                            }
                                                                                                                        });
                                                                                                            }
                                                                                    ...
                                                                                    if (task.isSuccessful()) {
                                                                                        ChatReferenceRef.child(list_user_id).child(currentUserID)
                                                                                                ...
                                                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                    ...
                                                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                                                        if (task.isSuccessful()) {
                                                                                                            Toast.makeText(getContext(), "Contatto eliminato", Toast.LENGTH_SHORT).show();
                                                                                                        }
                                                                                                    }
                                                                                                });
                                                                                    }
