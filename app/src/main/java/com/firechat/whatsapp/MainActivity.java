...
public class MainActivity extends AppCompatActivity {
    ...
    private void RequestNewGroup() {
        ...
        groupNameField.setHint("ex: 5A INF");
        ...
        builder.setPositiveButton("Crea", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(groupName)) {
                    Toast.makeText(MainActivity.this, "Inserisci il nome di un gruppo", Toast.LENGTH_SHORT).show();
                } else {
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(MainActivity.this, groupName + " è stato creato con successo.", Toast.LENGTH_SHORT).show();
                        }
