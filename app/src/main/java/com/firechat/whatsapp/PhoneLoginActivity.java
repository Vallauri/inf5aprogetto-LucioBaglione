    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SendVerificationCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(PhoneLoginActivity.this, "Inserisci un numero di telefono", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    loadingBar.setTitle("Verifica cellulare");
                    loadingBar.setMessage("Attendi mentre verifichiamo il tuo cellulare");
        ...
        VerifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(PhoneLoginActivity.this, "Inserisci prima il codice di verifica", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    loadingBar.setTitle("Codice di verifica");
                    loadingBar.setMessage("Attendi mentre verifichiamo il tuo codice");
                    loadingBar.setCanceledOnTouchOutside(false);
                    loadingBar.show();
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e)
            {
                ...
                Toast.makeText(PhoneLoginActivity.this, "Numero non valido, aggiungi il prefisso.", Toast.LENGTH_LONG).show();
                loadingBar.dismiss();
                                   ...
                                   PhoneAuthProvider.ForceResendingToken token)
            {
                ...
                Toast.makeText(PhoneLoginActivity.this, "Il codice è stato inviato", Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            loadingBar.dismiss();
                            Toast.makeText(PhoneLoginActivity.this, "Loggato correttamente", Toast.LENGTH_SHORT).show();
                            SendUserToMainActivity();
                        }
                        else
                        {
                            String message = task.getException().toString();
                            Toast.makeText(PhoneLoginActivity.this, "Errore: " + message, Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                        }
                    }
                });
